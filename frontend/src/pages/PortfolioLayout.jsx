...
const PortfolioLayout = () => {
  ...
  if (status === 'not-found') {
    return <EmptyState title="Portfolio not found" text={`There's no portfolio at @${username}.`} />;
  }

  if (status === 'not-setup') {
    return <EmptyState title="Still under construction" text={`@${username} hasn't published their portfolio yet — check back soon.`} />;
  }
