...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <footer className="border-t border-gray-100 dark:border-gray-800 py-8 bg-gray-50/50 dark:bg-gray-950/20">
        <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs tracking-wider uppercase font-medium text-gray-400 dark:text-gray-500">
          <p>© {new Date().getFullYear()} portfolio publisher</p>
          <div className="flex items-center gap-2 normal-case tracking-normal text-sm">
            <span className="text-gray-400 dark:text-gray-500 text-xs tracking-wider uppercase font-medium">Have an issue?</span>
            <span className="text-gray-300 dark:text-gray-700 hidden sm:inline">•</span>
            <a 
              href="mailto:portfoliopublisher@gmail.com" 
              className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors duration-200 underline underline-offset-4 decoration-gray-200 dark:decoration-gray-800 hover:decoration-primary-500"
            >
