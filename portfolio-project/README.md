# 🚀 Full-Stack Multi-User Portfolio Platform
...
> hardcoded portfolio) into a true multi-user platform (every account gets its own
...
Visit `http://localhost:5173` for the platform homepage, `http://localhost:5173/u/<username>`
